...
('Mystery-Spiel',['Clue','Guess','MysteryTip','MysteryTipSubmission','MysterySettings']),
('Dateien, Galerie, Issues, Aufgaben',['FileLibraryFolder','FileLibraryItem','FileLibraryFolderAccess','GalleryItem','Issue','IssueComment','Task','Announcement']),
