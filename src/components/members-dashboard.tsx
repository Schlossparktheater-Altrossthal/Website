        ...
        <div className="flex flex-col gap-4 rounded-2xl border border-warning/50 bg-gradient-to-br from-warning/20 via-warning/10 to-warning/5 p-4 text-sm text-warning">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            ...
            {profileCompletion.total ? (
              <Badge
                className="inline-flex min-w-[7.5rem] justify-center border-warning/60 bg-warning/20 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.1em] text-warning shadow-[0_0_14px_rgba(255,176,0,0.35)] ring-2 ring-warning/50 ring-offset-1 ring-offset-background transition-shadow sm:self-start"
              >
                {percentLabel}
              </Badge>
            ) : null}
