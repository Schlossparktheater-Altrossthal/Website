          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="mt-3 max-w-xl text-balance text-lg text-muted-foreground">
                Open-Air-Aufführungen zwischen alten Baumkronen und modernen Inszenierungen. Wir
                verbinden junges Ensemble, regionale Geschichten und atmosphärische Musik zu einem
                sommerlichen Bühnenmoment.
              </p>
            </div>
