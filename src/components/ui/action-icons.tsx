...
export function DownloadIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Download className={className} aria-hidden {...props} />;
}

export function UploadIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Upload className={className} aria-hidden {...props} />;
}

export function SearchIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Search className={className} aria-hidden {...props} />;
}

export function FilterIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Filter className={className} aria-hidden {...props} />;
}

export function RefreshIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <RefreshCw className={className} aria-hidden {...props} />;
}

export function ChevronDownIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <ChevronDown className={className} aria-hidden {...props} />;
}

export function ChevronRightIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <ChevronRight className={className} aria-hidden {...props} />;
}

export function ChevronUpIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <ChevronUp className={className} aria-hidden {...props} />;
}

export function ArrowLeftIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <ArrowLeft className={className} aria-hidden {...props} />;
}

export function ArrowRightIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <ArrowRight className={className} aria-hidden {...props} />;
}

export function ArrowUpRightIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <ArrowUpRight className={className} aria-hidden {...props} />;
}

export function ExternalLinkIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
...
export function SuccessIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <CheckCircle2 className={className} aria-hidden {...props} />;
}

export function LoadingIcon({ className = "w-4 h-4 animate-spin", ...props }: { className?: string } & IconProps) {
...
export function EyeOffIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
...
export function CalendarIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Calendar className={className} aria-hidden {...props} />;
}

export function BellRingIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
...
export function MessageCircleIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
...
export function SettingsIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Settings className={className} aria-hidden {...props} />;
}

export function CreditCardIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <CreditCard className={className} aria-hidden {...props} />;
}

export function UtensilsIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
...
export function SparklesIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Sparkles className={className} aria-hidden {...props} />;
}

export function TheaterIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Theater className={className} aria-hidden {...props} />;
}

export function ShieldCheckIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
...
export function WifiOffIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <WifiOff className={className} aria-hidden {...props} />;
}

export function UserRoundIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <UserRound className={className} aria-hidden {...props} />;
}


export function GripVerticalIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <GripVertical className={className} aria-hidden {...props} />;
}
export function CalendarCheckIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <CalendarCheck className={className} aria-hidden {...props} />;
}

export function CalendarCogIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
...
export function BookOpenTextIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <BookOpenText className={className} aria-hidden {...props} />;
}

export function UsersRoundIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <UsersRound className={className} aria-hidden {...props} />;
}

export function HammerIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Hammer className={className} aria-hidden {...props} />;
}

export function PiggyBankIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <PiggyBank className={className} aria-hidden {...props} />;
}

export function CalendarRangeIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <CalendarRange className={className} aria-hidden {...props} />;
}

export function UtensilsCrossedIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <UtensilsCrossed className={className} aria-hidden {...props} />;
}

export function CirclePlusIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
...
export function PrinterIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Printer className={className} aria-hidden {...props} />;
}

export function ActivityIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Activity className={className} aria-hidden {...props} />;
}

export function AlertCircleIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <AlertCircle className={className} aria-hidden {...props} />;
}

export function AlertTriangleIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <AlertTriangle className={className} aria-hidden {...props} />;
}

export function ArrowDownAZIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <ArrowDownAZ className={className} aria-hidden {...props} />;
}

export function ArrowLeftRightIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <ArrowLeftRight className={className} aria-hidden {...props} />;
}

export function ArrowRightCircleIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <ArrowRightCircle className={className} aria-hidden {...props} />;
}

export function ArrowRightLeftIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <ArrowRightLeft className={className} aria-hidden {...props} />;
}

export function ArrowUpAZIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <ArrowUpAZ className={className} aria-hidden {...props} />;
}

export function AudioLinesIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <AudioLines className={className} aria-hidden {...props} />;
}

export function BadgeCheckIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <BadgeCheck className={className} aria-hidden {...props} />;
}

export function BarChart3Icon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
...
export function BookOpenIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <BookOpen className={className} aria-hidden {...props} />;
}

export function Building2Icon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Building2 className={className} aria-hidden {...props} />;
}

export function CalendarClockIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <CalendarClock className={className} aria-hidden {...props} />;
}

export function CalendarDaysIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <CalendarDays className={className} aria-hidden {...props} />;
}

export function CalendarHeartIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <CalendarHeart className={className} aria-hidden {...props} />;
}

export function CalendarPlusIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <CalendarPlus className={className} aria-hidden {...props} />;
}

export function CameraIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Camera className={className} aria-hidden {...props} />;
}

export function CheckCircleIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <CheckCircle className={className} aria-hidden {...props} />;
}

export function CheckCircle2Icon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <CheckCircle2 className={className} aria-hidden {...props} />;
}

export function CheckSquareIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <CheckSquare className={className} aria-hidden {...props} />;
}

export function ChevronLeftIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <ChevronLeft className={className} aria-hidden {...props} />;
}

export function ChevronsUpDownIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <ChevronsUpDown className={className} aria-hidden {...props} />;
}

export function CircleIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Circle className={className} aria-hidden {...props} />;
}

export function CircleXIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <CircleX className={className} aria-hidden {...props} />;
}

export function ClapperboardIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Clapperboard className={className} aria-hidden {...props} />;
}

export function ClipboardCheckIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <ClipboardCheck className={className} aria-hidden {...props} />;
}

export function ClipboardListIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <ClipboardList className={className} aria-hidden {...props} />;
}

export function Clock3Icon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
...
export function FileDownIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <FileDown className={className} aria-hidden {...props} />;
}

export function FileStackIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <FileStack className={className} aria-hidden {...props} />;
}

export function FilterXIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <FilterX className={className} aria-hidden {...props} />;
}

export function FolderOpenIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <FolderOpen className={className} aria-hidden {...props} />;
}

export function HardDriveIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <HardDrive className={className} aria-hidden {...props} />;
}

export function HeartHandshakeIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <HeartHandshake className={className} aria-hidden {...props} />;
}

export function HistoryIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <History className={className} aria-hidden {...props} />;
}

export function ImagesIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Images className={className} aria-hidden {...props} />;
}

export function LayersIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Layers className={className} aria-hidden {...props} />;
}

export function LayoutGridIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
...
export function ListChecksIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <ListChecks className={className} aria-hidden {...props} />;
}

export function ListTodoIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <ListTodo className={className} aria-hidden {...props} />;
}

export function Loader2Icon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Loader2 className={className} aria-hidden {...props} />;
}

export function MailCheckIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <MailCheck className={className} aria-hidden {...props} />;
}

export function MapPinIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <MapPin className={className} aria-hidden {...props} />;
}

export function Maximize2Icon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Maximize2 className={className} aria-hidden {...props} />;
}

export function MegaphoneIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Megaphone className={className} aria-hidden {...props} />;
}

export function MoonStarIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <MoonStar className={className} aria-hidden {...props} />;
}

export function Music3Icon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Music3 className={className} aria-hidden {...props} />;
}

export function PackageIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Package className={className} aria-hidden {...props} />;
}

export function PanelLeftIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <PanelLeft className={className} aria-hidden {...props} />;
}

export function PawPrintIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <PawPrint className={className} aria-hidden {...props} />;
}

export function PencilIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Pencil className={className} aria-hidden {...props} />;
}

export function PlugZapIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
...
export function RefreshCwIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <RefreshCw className={className} aria-hidden {...props} />;
}
...
export function Settings2Icon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Settings2 className={className} aria-hidden {...props} />;
}

export function Share2Icon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
...
export function TargetIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
...
export function Trash2Icon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Trash2 className={className} aria-hidden {...props} />;
}
...
export function TrophyIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <Trophy className={className} aria-hidden {...props} />;
}

export function UmbrellaIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
...
export function UserCheckIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <UserCheck className={className} aria-hidden {...props} />;
}

export function UserRoundCheckIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
...
export function WandSparklesIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
  return <WandSparkles className={className} aria-hidden {...props} />;
}

export function WrenchIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
...
export function XCircleIcon({ className = "w-4 h-4", ...props }: { className?: string } & IconProps) {
