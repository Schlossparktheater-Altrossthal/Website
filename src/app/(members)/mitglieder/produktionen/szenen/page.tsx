                  ...
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2 text-xs text-muted-foreground">
                        ...
                        {scene.sequence ? <span>#{scene.sequence}</span> : null}
                      </div>
                  ...
                  <div className="space-y-4">
                    <div className="rounded-lg border border-border/60 bg-background/70 p-4">
                      <details className="group relative [&_summary::-webkit-details-marker]:hidden">
                        <summary className="flex cursor-pointer items-center justify-between gap-3 pr-12 text-sm font-semibold text-foreground">
                    ...
                    <div className="space-y-3">
                      <details className="group relative rounded-lg border border-border/60 bg-background/70 p-4 [&_summary::-webkit-details-marker]:hidden">
                        <summary className="flex cursor-pointer items-center justify-between gap-3 pr-12 text-sm font-semibold text-foreground">
                          <span>Breakdown-Aufgaben</span>
                          <span className="flex items-center gap-2 text-xs text-muted-foreground">
                            {scene.breakdownItems.length} Aufgaben
                            <ChevronDown className="h-4 w-4 transition duration-200 group-open:rotate-180" aria-hidden />
                          </span>
                        </summary>
                        <Dialog>
                          <DialogTrigger asChild>
                            <Button
                              ...
                              size="icon"
                              className="absolute right-2 top-2 h-7 w-7"
                              aria-label="Breakdown hinzufügen"
                            >
                              <Plus className="h-4 w-4" aria-hidden />
                            </Button>
                          </DialogTrigger>
