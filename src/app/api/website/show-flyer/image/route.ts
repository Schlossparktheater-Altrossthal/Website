...
import {
  deleteProductionFlyerSettingsImage,
  readProductionFlyerSettings,
  saveProductionFlyerSettingsImage,
...
export async function GET() {
  ...
  return new NextResponse(Buffer.from(flyer.bildData), {
    headers: { "Content-Type": flyer.bildMimeType },
  });
}
