...
const DEFAULT_ANALYTICS: StaticAnalyticsData = {
  ...
  publicPages: [
    ...
    },
    {
      ...
      views: 7320,
      uniqueVisitors: 5410,
      avgTimeOnPageSeconds: 148,
      loadTimeMs: 1320,
      lcpMs: 2050,
      bounceRate: 0.24,
      exitRate: 0.22,
      avgScrollDepth: 0.72,
      goalCompletionRate: 0.22,
    },
    {
      path: "/galerie",
      title: "Galerie",
      ...
      exitRate: 0.28,
      avgScrollDepth: 0.64,
      goalCompletionRate: 0.11,
    },
    {
      path: "/unsere-schulkatze",
      title: "Unsere Schulkatze",
      views: 4825,
      uniqueVisitors: 3580,
      avgTimeOnPageSeconds: 125,
      loadTimeMs: 1230,
      lcpMs: 1840,
      bounceRate: 0.29,
      exitRate: 0.24,
      avgScrollDepth: 0.71,
      goalCompletionRate: 0.19,
    },
    {
      path: "/mystery",
      title: "Mystery",
      views: 3580,
      uniqueVisitors: 2910,
      avgTimeOnPageSeconds: 168,
      loadTimeMs: 1380,
      lcpMs: 2070,
      bounceRate: 0.33,
      exitRate: 0.19,
      avgScrollDepth: 0.67,
      goalCompletionRate: 0.27,
    },
  ],
  memberPages: [
    {
      ...
      views: 15840,
      uniqueVisitors: 2130,
      avgTimeOnPageSeconds: 186,
      loadTimeMs: 980,
      lcpMs: 1540,
      bounceRate: 0.12,
      exitRate: 0.08,
      avgScrollDepth: 0.82,
      goalCompletionRate: 0.54,
    },
    {
      ...
      views: 9320,
      uniqueVisitors: 1675,
      avgTimeOnPageSeconds: 204,
      loadTimeMs: 1040,
      lcpMs: 1620,
      bounceRate: 0.17,
      exitRate: 0.13,
      avgScrollDepth: 0.78,
      goalCompletionRate: 0.47,
    },
    {
      ...
      views: 7460,
      uniqueVisitors: 1390,
      avgTimeOnPageSeconds: 238,
      loadTimeMs: 1090,
      lcpMs: 1690,
      bounceRate: 0.15,
      exitRate: 0.17,
      avgScrollDepth: 0.74,
      goalCompletionRate: 0.52,
    },
    {
      path: "/mitglieder/archiv-und-bilder",
      title: "Archiv & Bilder",
      views: 5210,
      uniqueVisitors: 980,
      avgTimeOnPageSeconds: 176,
      loadTimeMs: 1120,
      lcpMs: 1740,
      bounceRate: 0.21,
      exitRate: 0.25,
    ...
    {
      path: "/mitglieder/meine-proben",
      title: "Meine Proben",
      views: 4860,
      uniqueVisitors: 1245,
      avgTimeOnPageSeconds: 212,
      loadTimeMs: 1010,
      lcpMs: 1580,
      bounceRate: 0.19,
      exitRate: 0.22,
      avgScrollDepth: 0.81,
      goalCompletionRate: 0.58,
    },
    {
      path: "/mitglieder/rollenverwaltung",
